...
Relational DB: wonderful thing (transactions, … )
But it wants to have all the data in it
Those databases tend to become too big too fail.
Because it is important we are worried about changing it.

(Camera focus - show some part of your hands as speaker - is more dynamic.

(Note: slides are shortly shown then it switches back to full screen for the speaker)
...
There is an idea from 1971: Information hiding
Idea is to hide as much information as you can, as soon as you expose it, it becomes part of the contract with the outside world.
...
Reporting database pattern (is on the site martin fowler)
...
Good read Ben: designing event driven systems: good read - and pretty short (add book)

Book: Monolith to microservices: about breaking up data
